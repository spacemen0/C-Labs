...
int main() {
	...
	cin >> d;
	cin.ignore(numeric_limits<streamsize>::max(), '\n');
	cout << "The word '" << d << "' has " << d.length() << " character(s)." << endl << endl;
	cout << "Enter an integer and a word: ";
	cin >> a >> d;
	cin.ignore(numeric_limits<streamsize>::max(), '\n');
	cout << "You entered '" << a << "' and '" << d << "'." << endl << endl;
	...
	cin >> d >> b;
	cin.ignore(numeric_limits<streamsize>::max(), '\n');
	cout << "You entered \"" << d << "\" and \"" << fixed  << b << "\"." << endl << endl;
	...
	cin >> d;
	cout << "You entered: " << d << " "; cin >> d; cout << d << " "; cin >> d; cout << d << endl << endl;
	cin.ignore(numeric_limits<streamsize>::max(), '\n');
	return 0;
}